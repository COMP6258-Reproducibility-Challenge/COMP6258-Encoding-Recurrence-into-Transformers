...
#!
parser.add_argument('--n_rsa_head', type=int, default=4,
                    help='number of RSA heads')
...
# print = create_exp_dir(args.work_dir,
...
try:
    for epoch in range(20): #itertools.count(start=1):
        train()
        if train_step == args.max_step:
            print('-' * 100)
